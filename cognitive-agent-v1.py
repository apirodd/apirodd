...
for e in range(total_episodes):
    ...
    for time in range(max_env_steps):
        ...
        if next_state==None:#new
            next_state=next_state_old#new
        else:
            next_state = np.reshape(next_state, [1, s_size])#old
            next_state_old=next_state#new
